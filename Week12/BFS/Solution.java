...
//
//    static int UNIT_COST = 6;
//
//    static int getDistance(ArrayList<ArrayList<Integer>> graph, int start, int end) {
//        int distance = 0;
//        if (graph.get(start).contains(end)) {
//            return UNIT_COST;
//        } else {
//            for (int i = 0; i < graph.get(start).size(); i++) {
//                return Math.min(getDistance(graph, graph.get(start).get(i), end), );
//            }
//        }
//    }
//
...
//            if (i != start) {
//                costs[i] = getDistance(graph, start, i);
//            }
//        }
//
//        return costs;
